...
import { ResidentMonthlyRentRow, ResidentRow, WalkInRow } from '../interface/resident.interface';
...
async createMonthlyRent(
  ...
  const result = await client.query(ResidentQueries.INSERT_RESIDENT_MONTHLY_RENT, [
    residentKuid,
